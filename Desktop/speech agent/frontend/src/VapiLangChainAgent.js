...
import Vapi from '@vapi-ai/web'; // ✅ Add this import
...
const VapiLangChainAgent = () => {
  ...
  const PUBLIC_KEY = "94773849-1326-483c-8611-6e69a9fe7b4f";
  const ASSISTANT_ID = "f4a9004a-0030-4f20-bd81-f96d65a300e9";

  useEffect(() => {
    // ✅ Use imported Vapi instead of window.Vapi
